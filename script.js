...
function emptyCart() {
  if (localStorage.length === 0) {
    ...
    orderDiv = document.getElementById('order')
    orderDiv.innerHTML = `<div class="d-flex flex-column"><label for="prenom">Prénom</label><br><input id="prenom" pattern="[A-Za-z]+" type="text" required></input></div><div class="d-flex flex-column"><label for="nom">Nom</label><br><input id="nom" pattern="[A-Za-z]+" type="text" required></input></div><div class="d-flex flex-column"><label for="adresse">Adresse</label><br><input id="adresse" type="text" required></input></div><div class="d-flex flex-column"><label for="ville">Ville</label><br><input id="ville" pattern="[A-Za-z]+" type="text" required></input></div><div class="d-flex flex-column"><label for="email" required>Email</label><br><input id="email" type="email"></input></div><br><div class="text-center"><button type="submit" id="btnorder" class="btn btn-success">Commander</button></div>`;
  }
}
